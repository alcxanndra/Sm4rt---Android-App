...
public class FirebaseMessageReceiver
    ...
    onMessageReceived(RemoteMessage remoteMessage) {
        ...
        // Since here we do not have any data payload, this section is commented out.
        // It is here only for reference purposes.
        ...
        if (remoteMessage.getNotification() != null) {
            // Since the notification is received directly from FCM,
            // the title and the body can be fetched directly as below.
            showNotification(
    ...
    public void showNotification(String title, String message) {
        ...
        // set only for Android versions 4.1 and above.
